...
var WiresphereConfig = {
	Background: {
		...
		Gradient: {
			...
			StopAColor: '178, 64, 64', // Background animated gradient Stop A
			StopBColor: '178, 64, 64', // Background animated gradient Stop B
	...
	Colors: {
		...
		Tagline: {							// Tagline
			FirstLine: '#8F1D21',			// Color of first line of tagline
			SecondLine: '#ffffff'			// Color of second line of tagline
		},

		Buttons: {							// Buttons
Outline : '#8F1D21 ', // Color of buttons outline
